Pod::Spec.new do |s|
  ...
  s.public_header_files = "Classes/**/*.h", "Libraries/unrar/raros.hpp", "Libraries/unrar/dll.hpp", "Classes/UnrarKit.h"  # Include all headers in the Classes directory and the new headers
